...
function SignUp() {
    ...
    function handleSignUp(){
           const res=axios.post("http://localhost:8000/api/auth/signin",{email,password});
           console.log(res);
    }
  return (
    <div className='min-h-screen w-full flex items-center justify-center p-4' style={{backgroundColor:bgColor}}>
        <div className='w-full max-w-md shadow-lg border-[1px] bg-white rounded-xl p-8 ' style={{border:`1px solid ${borderColor}`}}>
            ...
            <p className='text-gray-600 mb-8'>Sign in your account to get started with delicious food delivery</p>
            ...
            <p className='text-center mt-2 cursor-pointer hover:bg-gray-200 px-3 py-2  rounded-lg' onClick={()=>{navigate("/signup")}} >Want to create Account ? <span className='text-[#ff4d2d]'>Sign Up</span></p>
